"""Verify analytics relations created by the idempotent SQL build."""
...
def main() -> None:
    required = ["fact_club_recruitment", "fact_player_development", "fact_club_sales", "transfer_pathways", "squad_alerts"]
